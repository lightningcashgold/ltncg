...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lightningcash_gold: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a lightningcash_gold: URI or payment request"));
